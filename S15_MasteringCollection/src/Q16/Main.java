...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Arrays.fill(cardArray, aceOfHearts);//Arrays.fill(array, value);
        Card.printDeck(Arrays.asList(cardArray), "Aces of Hearts", 1);

        List<Card> cards = new ArrayList<>(52);
        Collections.fill(cards, aceOfHearts);//Collections.fill(list, value);
        ...
        Collections.reverse(deck);//reverse
        ...
        //subList(start, end) lấy danh sách từ start đến end - 1
        ...
        // tìm vị  trí của tens theo index
        //        Collections.shuffle(deck);
        // -1
        int subListIndex = Collections.indexOfSubList(deck, tens);
        System.out.println("sublist index for tens = " + subListIndex);
        System.out.println("Contains = " + deck.containsAll(tens));//containsAll()
