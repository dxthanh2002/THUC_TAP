...
record Customer(String name, ArrayList<Double> transactions) {
    ...
    public Customer(String name, double initialDeposit) {
        ...
        transactions.add(initialDeposit);//initialDeposit double -> Double
    }
}

public class AutoboxChallenge_42 {
...
class Bank {
    ...
    public void printStatement(String customerName) {
        ...
        for (double d : customer.transactions()) {  // unboxing Double thành double
