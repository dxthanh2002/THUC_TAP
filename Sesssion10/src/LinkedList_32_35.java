...
//LinkedList là Mảng chứa dữ liệu và con trỏ
//(add, addFirst, addLast, offer, offerFirst, offerLast)
//(remove, removeFirst, removeLast, poll, pollFirst, pollLast)
//Lấy phần tử (get, getFirst, getLast, peek(trả về null nếu rỗng), peekFirst, peekLast)
//set
//(contains, isEmpty, size)
//clear()
//(for, forEach, iterator)
//reverse
public class LinkedList_32_35 {
...
//        gettingElements(placesToVisit);
    ...
    // gán ListIterator = list.listIterator();
    }
